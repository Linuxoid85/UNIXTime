...
`/tmp` смонтирован как RAMFS, что значит его автоматическое очищение после выключения компьютера. В принципе неплохо. В том же Linux для эьтих целей монтируют `/tmp` как `tmpfs`.
