...
Очень, очень полезная функция — возможность поиска команд в строке меню, особенно в приложениях с подменю. Mac умеет это делать:

<div align="center">
<img src="pic/mac-search.webp">
<p><small>При вводе запроса отображаются соответствующие пункты меню, начиная с Mac OS X 10.5 Leopard</small></p>
</div>

Есть ли эквивалент для рабочих окружений Linux?

После того, как оригинальная статья была опубликована, [@aviwad](https://twitter.com/aviwad) указал мне на [Plotinus](https://github.com/p-e-w/plotinus), который, кажется, идёт в этом направлении:

<div align="center">
<img src="pic/plotinus.gif">
<p><small>Plotinus. Источник: <a href="https://github.com/p-e-w/plotinus">GitHub</a></small></p>
</div>

Но вы *должны знать* о нём, *должны установить* его, *должны знать комбинацию клавиш <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>P</kbd>*, чтобы вызвать его. Таким образом, его вообще нельзя обнаружить. Он не показывает пространственное расположение команд в меню, так что вы не узнаете, как пользоваться приложением от Plotinus, в отличие от меню Apple с возможностью поиска И, судя по всему, оно работает только в приложениях GTK+ — небольшом подмножестве приложений, используемых в рабочих окружениях Linux.

Спустя долгное время после публикации оригинала этой статьи мне [указали на то](https://twitter.com/NeoTheThird/status/949696808728629249), что MATE может делать глобальные меню и поиск в них. Хотя я приветствую наличие в MATE этих функций, я считаю, что менее 0,1% пользователей когда-либо смогут их найти: вы должны зайти в «Параметры» -> «MATE Tweak» -> «Панель» -> «Cupertino». После этого глобальное меню будет включено. Для поиска в меню вы должны знать (волшебным образом?), что вам нужно нажать <kbd>Alt</kbd>. Это должно быть *гораздо более удобным*.

А вот с Firefox 57 (Quantum) он, похоже, так и не заработал.

<div align="center">
<img src="pic/firefox-menu.webp">
<p><small>Отсутствие глобального меню в Firefox 57 даже при явном включении в Ubuntu MATE 17.10</small></p>
</div>

(ОБНОВЛЕНО в январе 2019) Оказывается, в некоторых приложениях, включая Blender и Olive, есть нечто подобное под названием «Action Search», но чтобы его увидеть, нужно нажать <kbd>/</kbd> на клавиатуре.

Кто на Земле просыпается однажды утром и говорит: «Дай-ка я посмотрю, что будет, если я нажму "/" в приложении Linux"? Интересно, кто придумывает эти пасхалки?

*Сообщество должно работать над тем, чтобы сделать меню с возможностью поиска на рабочем столе Linux. Может быть, новый проект XDG?*
